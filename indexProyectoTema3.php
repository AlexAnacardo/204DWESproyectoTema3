<html>
     <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
         <link rel="stylesheet" href="webroot/css/indexProyectoTema3.css">
     ...
     <body>
        ...
        <main>             
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>11</td>
                        <td>Mostrar el documento PHPDoc del proyecto que se está ejecutando generado con PHP Documentor o ApiGen. (avanzado-opcional)</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>13</td>
                        <td>Crear una función que cuente el número de visitas a la página actual desde una fecha concreta. (avanzado-opcional)</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>19</td>
                        <td>Construir una librería de funciones de validación de campos de formularios (LibreríaValidacionFormularios.php) para utilizarla en los siguientes ejercicios. Discusión: diferencia entre librería de funciones y clase. (avanzado-opcional)</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><a href="codigoPHP/ejercicio24.php"><image src="webroot/images/play.png" heigth="25%" width="25%"/></a></td>
                        <td><a href="mostrarcodigo/muestraEjercicio24.php"><image src="webroot/images/ojo.png" heigth="30%" width="30%"/></a></td>
                    </tr>
                    <tr>
                        <td>25</td>
        ...
        <footer>
            ...
            <p><a target="blank" href="https://github.com/AlexAnacardo/204DWESProyectoTema3">Repositorio del proyecto</a></p>
        </footer>
     </body>
 </html>
